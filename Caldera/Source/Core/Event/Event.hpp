...
{
  public:
  Event(EventType type, StringView name)
      : type(type)
      , name(name)
  {
  }
  ...
  template <class Type> inline Type toType() const
  {
    if (auto* ret = dynamic_cast<Type>(this))
      return ret;
    return {};
  }
...
class EventDispatcher
{
  ...
  public:
  void addListener(EventType type, const Func& func)
  {
